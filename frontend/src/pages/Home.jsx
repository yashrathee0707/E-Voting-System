...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-yellow-50 to-indigo-100 text-gray-800 px-6 py-10">
      ...
      <main className="flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto mt-20">
        {/* Text section */}
        <div className="md:w-1/2 space-y-6">
          <h1 className="text-4xl md:text-5xl font-bold text-indigo-800 leading-tight">
            Welcome to Your <span className="text-yellow-500">E-voting</span> Platform
          </h1>
